...
async def broadcast_handler(m: Message):
    ...
    out = await m.reply_text(
        text=f"Broadcast Dimulai! Anda akan diberi tahu dengan file log ketika semua pengguna diberi tahu."
    )
